...
function buildDutchGrantPopUpInfo(props) {
  ...
  if (typeof dutch_grant_lots_info[props.Lot] == "undefined") {
    ...
    if (dutch_grant_lots_info[props.Lot].builds.length > 0) {
      for (let i = 0; i < dutch_grant_lots_info[props.Lot].builds.length; i++) {
        builds_imgs +=
          ...
          dutch_grant_lots_info[props.Lot].builds[i] +
          "'  width='258' ><br><br>";
      }
    }
    popup_html =
    ...
    if (dutch_grant_lots_info[props.Lot].to_party.length > 0) {
      popup_html +=
        "<b>To Party:</b><i>" +
        dutch_grant_lots_info[props.Lot].to_party +
        "</i><br><br>";
    } else {
      if (dutch_grant_lots_info[props.Lot].name_txt.length > 0) {
        popup_html +=
          "<b>To Party:</b><i>" +
          dutch_grant_lots_info[props.Lot].name_txt +
          "</i><br><br>";
      }
    }
    if (dutch_grant_lots_info[props.Lot].from_party.length > 0) {
      popup_html +=
        "<b>From Party:</b><i>" +
        dutch_grant_lots_info[props.Lot].from_party +
        "</i><br><br>";
    }
    if (dutch_grant_lots_info[props.Lot].start.length > 0) {
      popup_html +=
        "<b>Start:</b> <i>" +
        dutch_grant_lots_info[props.Lot].start +
        "</i><br>";
    }
    if (dutch_grant_lots_info[props.Lot].end.length > 0) {
      popup_html +=
        "<b>End:</b> <i>" +
        dutch_grant_lots_info[props.Lot].end +
        "</i><br><br>";
    }
    if (dutch_grant_lots_info[props.Lot].descr.length > 0) {
      popup_html +=
        ...
        "<br>" +
        "<i>" +
        dutch_grant_lots_info[props.Lot].descr +
        "</i>";
    }
...
function buildGravesendPopUpInfo(props) {
  ...
  if (typeof brooklyn_grants_info[props.node] == "undefined") {
    ...
    if (brooklyn_grants_info[props.node].title.length > 0) {
      popup_html +=
        "<b>" + brooklyn_grants_info[props.node].title + "</b><br><br>";
    }
    if (brooklyn_grants_info[props.node].date_start.length > 0) {
      popup_html +=
        "<b>Start:</b> <i>" +
        brooklyn_grants_info[props.node].date_start +
        "</i><br><br>";
    }
    if (brooklyn_grants_info[props.node].name.length > 0) {
      popup_html +=
        ...
        props.node +
        "' target='_blank' >" +
        brooklyn_grants_info[props.node].name +
        "</a><br><br>";
    }
    if (
      brooklyn_grants_info[props.node].to_party.length > 0 ||
      brooklyn_grants_info[props.node].to_party2.length > 0
    ) {
      ...
      if (brooklyn_grants_info[props.node].to_party_linked.length > 0)
        popup_html +=
          "<a href='" +
          brooklyn_grants_info[props.node].to_party_linked +
          "' target='_blank'>" +
          brooklyn_grants_info[props.node].to_party +
          "</a><br>";
      else
        popup_html +=
          "<i>" + brooklyn_grants_info[props.node].to_party + "</i><br>";

      if (brooklyn_grants_info[props.node].to_party2_linked.length > 0)
        popup_html +=
          "<a href='" +
          brooklyn_grants_info[props.node].to_party2_linked +
          "' target='_blank'>" +
          brooklyn_grants_info[props.node].to_party2 +
          "</a><br>";
      else
        popup_html +=
          "<i>" + brooklyn_grants_info[props.node].to_party2 + "</i><br>";
    }
    if (brooklyn_grants_info[props.node].from_party.length > 0) {
      if (brooklyn_grants_info[props.node].from_party_linked.length > 0)
        popup_html +=
          ...
          brooklyn_grants_info[props.node].from_party_linked +
          "' target='_blank'>" +
          brooklyn_grants_info[props.node].from_party +
          "</a><br><br>";
      else
        popup_html +=
    ...
    if (brooklyn_grants_info[props.node].indigenous_signatories.length > 0) {
      popup_html +=
        ...
        brooklyn_grants_info[props.node].indigenous_signatories.replace(
          /\\n/g,
          "<br>"
        ) +
        "</i><br>";
...
function buildFarmsPopUpInfo(props) {
  ...
  if (typeof farms_grants_info[props.NID_num] == "undefined") {
    ...
    if (farms_grants_info[props.NID_num].name.length > 0) {
      popup_html +=
        "<b>" + farms_grants_info[props.NID_num].name + "</b><br><br>";
    }
    if (farms_grants_info[props.NID_num].to_party.length > 0) {
      if (farms_grants_info[props.NID_num].to_party_linked.length > 0)
        popup_html +=
          "<b>To Party:</b> <a href='" +
          farms_grants_info[props.NID_num].to_party_linked +
          "' target='_blank'>" +
          farms_grants_info[props.NID_num].to_party +
          "</a><br>";
      else
        popup_html +=
          "<b>To Party:</b><i>" +
    ...
    if (farms_grants_info[props.NID_num].from_party.length > 0) {
      if (farms_grants_info[props.NID_num].from_party_linked.length > 0)
        popup_html +=
          "<b>From Party:</b> <a href='" +
          farms_grants_info[props.NID_num].from_party_linked +
          "' target='_blank'>" +
          farms_grants_info[props.NID_num].from_party +
          "</a><br>";
      else
        popup_html +=
          "<b>From Party:</b><i>" +
    ...
    if (farms_grants_info[props.NID_num].date_start.length > 0) {
      popup_html +=
        "<b>Start:</b> <i>" +
        farms_grants_info[props.NID_num].date_start +
        "</i><br>";
    }
    if (farms_grants_info[props.NID_num].date_end.length > 0) {
      popup_html +=
        "<b>End:</b> <i>" +
        farms_grants_info[props.NID_num].date_end +
        "</i><br>";
    }
    if (farms_grants_info[props.NID_num].type.length > 0) {
      popup_html +=
        "<br><b>Type:</b> <i>" +
        farms_grants_info[props.NID_num].type +
        "</i><br>";
    }
  }
