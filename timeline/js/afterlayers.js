...
function addAfterLayers(_, date) {
  ...
  function addEventListenersOnMouseHover() {
  ...
  function addEventListenersOnMouseOffHover() {
  ...
  function changeToCursorWhenHovering() {
  ...
  function changeToPointerWhenHovering() {
  ...
  removeTaxLot();
  addGrantsPolygon();
  addEventListenersOnMouseHover();
  addEventListenersOnMouseOffHover();
  addTaxLotPoints();
  changeToCursorWhenHovering();
  changeToPointerWhenHovering();
}
...
function addGrantLotsAfterLayers(date) {
  ...
  function addALayerShowingThePlaces() {
...
function addGrantLotsLinesAfterLayers(date) {
  function removeTaxLotPointsIfExist() {
    if (afterMap.getLayer("grant-lots-lines-right"))
      afterMap.removeLayer("grant-lots-lines-right");
    if (afterMap.getSource("dutch_grants_lines-0y4gkx"))
      afterMap.removeSource("dutch_grants_lines-0y4gkx");
  }
...
function addCurrentLotsAfterLayers() {
  ...
  if (afterMap.getLayer("curr-lots-right"))
    afterMap.removeLayer("curr-lots-right");
  if (afterMap.getSource("current_lots-94syr2"))
    afterMap.removeSource("current_lots-94syr2");
...
function addCurrentLotsLinesAfterLayers() {
  //REMOVING CURRENT LOTS IF EXIST
  if (afterMap.getLayer("curr-lots-lines-right"))
    afterMap.removeLayer("curr-lots-lines-right");
  if (afterMap.getSource("current_lots_lines-41dc4r"))
    afterMap.removeSource("current_lots_lines-41dc4r");
...
function addCurrentBuildingsLinesAfterLayers() {
  //REMOVING CURRENT LOTS IF EXIST
  if (afterMap.getLayer("curr-builds-lines-right"))
    afterMap.removeLayer("curr-builds-lines-right");
  if (afterMap.getSource("current_buildings_lines-3k97hu"))
    afterMap.removeSource("current_buildings_lines-3k97hu");
...
function addCurrentBuildingsAfterLayers() {
  //REMOVING CURRENT LOTS IF EXIST
  if (afterMap.getLayer("curr-builds-right"))
    afterMap.removeLayer("curr-builds-right");
  if (afterMap.getSource("current_buildings_1-cjgsm"))
    afterMap.removeSource("current_buildings_1-cjgsm");
