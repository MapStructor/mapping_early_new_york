...
//<a href="https://www.w3schools.com" target="_blank">Visit W3Schools!</a>
					...
					*/
					...
					//Date Range
					"<b> DATES: </b>" +
					e.features[0].properties.DayStart + " - " + e.features[0].properties.DayEnd +
					"<br>" +
					"<br>" +
					...
					*/
					...
					//Owner 1
					'<a href=http://thenittygritty.org' + e.features[0].properties.field_part + ": " +
					"<br>" +
					'<a href=http://thenittygritty.org' + e.features[0].properties.field_to +
					" (" + '<a href=http://thenittygritty.org' + e.features[0].properties.field_enti + ")" +
					"<br>" +
					"<br>" +

					//Owner 2
					'<a href=http://thenittygritty.org' + e.features[0].properties.field_pa_1 + ": " +
					"<br>" +
					'<a href=http://thenittygritty.org' + e.features[0].properties.field_to_p +
					" (" + '<a href=http://thenittygritty.org' + e.features[0].properties.field_en_1 + ")" +
					...
					//Taxlot Event Type
					'<a href=http://thenittygritty.org' + e.features[0].properties.field_ta_1 +
					"<hr>" +

					"<b> FROM:</b>" +
					"<br>" +
					//From 1
					'<a href=http://thenittygritty.org' + e.features[0].properties.field_pa_2 + ": " +
					"<br>" +
					'<a href=http://thenittygritty.org' + e.features[0].properties.field_from +
					" (" + '<a href=http://thenittygritty.org' + e.features[0].properties.field_en_2 + ")" +
					"<br>" +
					"<br>" +

					
					//From 2
					'<a href=http://thenittygritty.org' + e.features[0].properties.field_pa_3 + ": " +
					"<br>" +
					'<a href=http://thenittygritty.org' + e.features[0].properties.field_fr_1 +
					" (" + '<a href=http://thenittygritty.org' + e.features[0].properties.field_en_3 + ")" +
