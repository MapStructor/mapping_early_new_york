if (
  ...
  $(document).ready(function () {
      ...
      slide: function (event, ui) {
        ...
        if (demo_layer_view_flag) {
          if (ui.value <= sliderStartDrag) {
            ...
            $("#date").text(
              moment.unix(sliderStartDrag).format("DD MMM YYYY")
            );
            return false;
          }
          if (ui.value >= sliderEndDrag) {
            ...
            $("#date").text(
              moment.unix(sliderEndDrag).format("DD MMM YYYY")
            );
            return false;
          }
    ...
    $(".current_buildings").change(function () {
      if (
        $(".current_buildings:checked").length ==
        $(".current_buildings").length
      ) {
    ...
    $(".gravesend_layer").change(function () {
      if (
        $(".gravesend_layer:checked").length == $(".gravesend_layer").length
      ) {
          ...
          for (let i = 0; i < data.length; i++) {
            ...
            if (typeof data[i].nid[0].value != "undefined") {
              ...
              taxlot_event_entities_info[data_info_index] = {
                name:
                  data[i].title.length > 0 ? data[i].title[0].value : "",
                name_html:
                  data[i].title.length > 0
                    ? (data[i].path.length > 0
            ...
            if (typeof data[i].title != "undefined") {
              ...
              if (data_info_index !== null) {
                taxlot_events_info[data_info_index] = {
                  ...
                  to_party_1_text: data[
                    i
                  ].field_events_to_party_1_text_.replace(
                    "href=\u0022",
                    "target=\u0022_blank\u0022 href=\u0022https:\/\/nahc-mapping.org\/mappingNY\/encyclopedia"
                  ),
                  ...
                  to_party_1_entity: data[
                    i
                  ].field_entity_description_to_.replace(
                    "href=\u0022",
                    "target=\u0022_blank\u0022 href=\u0022https:\/\/nahc-mapping.org\/mappingNY\/encyclopedia"
                  ),
                  to_party_2_text: data[
                    i
                  ].field_asdf_to_party_2_text_.replace(
                    "href=\u0022",
                    "target=\u0022_blank\u0022 href=\u0022https:\/\/nahc-mapping.org\/mappingNY\/encyclopedia"
                  ),
                  ...
                  from_party_1_text: data[
                    i
                  ].field_from_party_1_text_.replace(
                    "href=\u0022",
                    "target=\u0022_blank\u0022 href=\u0022https:\/\/nahc-mapping.org\/mappingNY\/encyclopedia"
                  ),
                  ...
                  from_party_2_text: data[
                    i
                  ].field_from_party_2_text_.replace(
                    "href=\u0022",
                    "target=\u0022_blank\u0022 href=\u0022https:\/\/nahc-mapping.org\/mappingNY\/encyclopedia"
                  ),
